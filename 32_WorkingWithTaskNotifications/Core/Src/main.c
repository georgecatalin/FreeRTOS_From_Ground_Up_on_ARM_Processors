...
int main(void)
{
  ...
  xTaskCreate(vHandlerTask, "Task Handler", STACK_SIZE, NULL, 2, &xHandlerTask);// Priority does not matter since it is a single task in this example
...
void EXTI15_10_IRQHandler(void)
{
	...
	EXTI->PR = (1UL<<13); //we deal about PC13
